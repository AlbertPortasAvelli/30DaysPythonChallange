...
if __name__ == "__main__":
    ...
    print("The first name is equal to the last name." if first_name == last_name else
          "The first name is not equal to the last name.")
    print("The first name comes before the last name alphabetically." if first_name < last_name else
          ("The first name comes after the last name alphabetically." if first_name > last_name else
    ...
    print('Area : {}'.format(area_of_circle))
    ...
    print('Circumference : {}'.format(circum_of_circle))
